         ...
         $(document).ready(function () {
           ...
           $(document).on('paste keyup', 'textarea#excelPasteBox', function (e) {
             e.preventDefault();
             var cb;
             var clipText = '';
           ...
           $(document).on('paste keyup', 'textarea#excelPasteBox, #excelDataTable', function () {
         ...
         $(document.body).on('keyup', '#excelDataTable', function () {
             //alert('editable changed');
             $('#exportJsonData').trigger('click');
           })
